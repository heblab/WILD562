                   ...
                   )
{
  ...
  binrank(   kxv( present=present,
                 ...
                 predfun=function(mod, dat) {
                   predict.glm(object=mod, newdata=dat, type="response")
                 }
                 ),
          nbin=nbin,
          fitted=function(mod){
...
##                    ## random-effects terms for the model
...
##                    ## additional arguments to glmmPQL
...
##                data=data,
##                modfun=function(dat) {
##                  glmmPQL(fixed=fixed, random=random, family=family,
##                      data=dat, ...)
##                },
##                predfun=function(mod, dat) {
##                  predict(object=mod, newdata=dat)
##                }
##                ),
##           nbin=nbin,
##           fitted=function(mod){
...
##                },
##                predfun=function(mod, dat) {
##                  predict.coxph(object=mod, newdata=dat, type="risk")
##                }
##                ),
##           nbin=nbin,
##           fitted=function(mod){
##             predict.coxph(object=mod, type="risk")[1:sum(! present)]
##           }
##           )
## }
