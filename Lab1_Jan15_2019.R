...
banffEast <-read.csv("/Users/mark.hebblewhite/Box Sync/Teaching/UofMcourses/WILD562/Spring2019/Labs/Lab1_rintro/Banffeast.csv", header=TRUE, sep=",", na.strings="NA", dec=".", strip.white=TRUE)
banffWest <-read.csv("/Users/mark.hebblewhite/Box Sync/Teaching/UofMcourses/WILD562/Spring2019/Labs/Lab1_rintro/Banffwest.csv", header=TRUE, sep=",", na.strings="NA", dec=".", strip.white=TRUE)
## or 
setwd("/Users/mark.hebblewhite/Box Sync/Teaching/UofMcourses/WILD562/Spring2019/Labs/Lab1_rintro/")
...
plot(Elkwestraw~Year, reg.line=FALSE, smooth=FALSE, spread=FALSE, boxplots=FALSE, span=0.5, xlab="Years", ylab="East Zone Population", data=banffWest)
...
par(mfrow = c(1,2))
plot(EastElk~Year, reg.line=FALSE, smooth=FALSE, spread=FALSE, boxplots=FALSE, span=0.5, xlab="Years", ylab="East Zone Population", 
data=banffEast)
...
ggplot(banffWest, aes(x=Year, y=Elkwestraw)) +geom_point(shape=2, size = 6)
ggplot(banffWest, aes(x=Year, y=Elkwestraw)) +geom_point(shape=2, size = 6) + stat_smooth(method=lm)
ggplot(banffWest, aes(x=Year, y=Elkwestraw)) +geom_point(shape=2, size = 6) + stat_smooth(method=loess)

# Make a time-series scatterplot
par(mfrow = c(1,1)) ## first need to reset graphical parameters
plot(EastElk~Year, reg.line=FALSE, smooth=FALSE, spread=FALSE, 
  boxplots=FALSE, span=0.5, xlab="Years", ylab="East Zone Population",   data=banffEast)
...
# Import the data csv 
cougar <- read.table("/Users/mark.hebblewhite/Box Sync/Teaching/UofMcourses/WILD562/Spring2019/Labs/Lab1_rintro/golfcourse_cougar.csv", header=TRUE, sep=",", na.strings="NA", dec=".", strip.white=TRUE)
...
writeRaster(deer_w, "new_deer.tiff", "GTiff", overwrite=TRUE)
