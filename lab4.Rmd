...
$$\omega_j = \frac {\upsilon_j}{\alpha_i}$$
...
where $\beta_j$ is said to be the Scaled Selectivity Coefficient for habitat class __j__. 
...
$$\ln(\omega_j) = ln(\frac {\upsilon_j}{\alpha_i})$$
